...
if __name__ == "__main__":
  ...
  parser.add_argument("--private-key", required=True, help="The path to the private key")
  parser.add_argument("--public-key", required=True,  help="The path to the public key that will be generated")
  parser.add_argument("--device-policy", required=True, help="The path to the device policy file")
  parser.add_argument("--new-policy", required=True,  help="The modified policy file that is generated")
